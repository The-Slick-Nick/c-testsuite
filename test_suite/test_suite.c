...
#define ASSERT_EQUAL_FLOAT(val1, val2)          assert_equal_float(ts, val1, val2)
#define ASSERT_NOT_EQUAL_FLOAT(val1, val2)      assert_not_equal_float(ts, val1, val2)
#define ASSERT_GREATER_THAN_FLOAT(val1, val2)   assert_greater_than_float(ts, val1, val2)

#define ASSERT_EQUAL_DOUBLE(val1, val2)         assert_equal_double(ts, val1, val2)
#define ASSERT_NOT_EQUAL_DOUBLE(val1, val2)     assert_not_equal_double(ts, val1, val2)
#define ASSERT_GREATER_THAN_DOUBLE(val1, val2)  assert_greater_than_double(ts, val1, val2)
